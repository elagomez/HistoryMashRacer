...
{
	internal class ELineStandardShaderGUI : ShaderGUI
	{
		...
		private static class Styles
		{
			...
			public static string depthTest = "Depth Test";
		...
		void DepthTestPopup()
		{
			EditorGUI.showMixedValue = depthTest.hasMixedValue;
			var mode = (DepthTest)depthTest.floatValue;

			EditorGUI.BeginChangeCheck();
			mode = (DepthTest)EditorGUILayout.Popup( Styles.depthTest, (int)mode, Styles.depthTestNames );
			if( EditorGUI.EndChangeCheck() )
			{
				m_MaterialEditor.RegisterPropertyChangeUndo( "Depth Test" );
				depthTest.floatValue = (float)mode;
			}
